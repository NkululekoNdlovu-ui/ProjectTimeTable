...
//        ImageIcon imageIcon = new ImageIcon("C:\\Users\\DELL\\downloads\\maxresdefault"); // Ensure the path is correct
...
public class MainGui extends JFrame {
    ...
    private JButton generate, venue, subject, lecture, groups, viewTimetable;
    private CardLayout cardLayout;
    private JPanel contentHolder;
    ...
    private void setGui() {
        ...
        GenerateGui generateGui = new GenerateGui();
        SubjectGui subjectGui = new SubjectGui();
        ViewTimetableGui viewTimetableGui = new ViewTimetableGui();
        ...
        contentHolder.add(generateGui, "Generate");
        contentHolder.add(subjectGui, "Subject");
        contentHolder.add(viewTimetableGui, "ViewTimetable");
        ...
        generate.addActionListener(e -> cardLayout.show(contentHolder, "Generate"));
        subject.addActionListener(e -> cardLayout.show(contentHolder, "Subject"));
        viewTimetable.addActionListener(e -> cardLayout.show(contentHolder, "ViewTimetable"));
